...
public class UsuarioTests
{
    ...
    public void AdicionarFavorito_ComDonghuaValido_DeveAdicionarNaLista()
    {
        ...
        var donghua = new Donghua("Donghua Teste", "Descrição do Donghua Teste", "Tencent" , new DateTime(2018) ,  DonghuaType.Serie, DonghuaStatus.EmAndamento,  "https://www.donghua.com.br/cover.jpg", Genre.Wuxia | Genre.Xianxia | Genre.Acao);
        var donghua2 =  new Donghua(title: "A Lenda de Nezha",sinopse: "Nezha, um jovem com poderes divinos, luta contra seu destino para proteger sua família e o mundo.",studio: "Light Chaser Animation",releaseDate: new DateTime(2019) ,type: DonghuaType.Movie,status: DonghuaStatus.Concluido,image: "https://exemplo.com/images/nezha.jpg",genres: Genre.Historico | Genre.Romance | Genre.Acao);
        //Act
        usuario.AddFavorite(donghua);
        usuario.AddFavorite(donghua2);

        // Assert
        Assert.True(usuario.Favorites.Any(f => f.UserId == usuario.Id));
        Assert.True(usuario.Favorites.Any(f => f.UserId == usuario.Id));
    ...
    public void DonghuaInvalido_DeveLancarExcecao_Duplicado()
    {
        ...
        Donghua donghua = new Donghua("Donghua Teste", "Descrição do Donghua Teste", "Tencent" ,new DateTime(2018) ,  DonghuaType.Serie, DonghuaStatus.EmAndamento,  "https://www.donghua.com.br/cover.jpg", Genre.Wuxia | Genre.Xianxia | Genre.Acao);
